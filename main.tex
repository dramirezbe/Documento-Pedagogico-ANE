...
% Entrada segura de capítulos.
% Si el archivo existe, se incluye.
% Si el archivo no existe, se omite sin crear capítulos artificiales.
\newcommand{\inputchapter}[1]{
    \IfFileExists{#1.tex}{
        \input{#1}
    }{
        \typeout{ADVERTENCIA: No se encontró el archivo #1.tex. Se omite del documento.}
    }
}
...
% Muestra en la tabla de contenido solo hasta \section
\setcounter{tocdepth}{1}
\begin{document}
