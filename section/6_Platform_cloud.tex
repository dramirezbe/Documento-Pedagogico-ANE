...
humana y de coordinación central del sistema de monitoreo espectral ANE-HX. La
...
ANE-HX. Como se describe en el capítulo de diseño general (Capítulo~3), el
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{section/img/cap6_plat/GENERAL-diagram.jpeg}
    \caption{Diagrama general de la arquitectura de la plataforma web. Fuente: Elaboración propia.}
    \label{fig:platform_general_diagram}
\end{figure}
